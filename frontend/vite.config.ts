    ...
    VitePWA({
      ...
      injectManifest: {
        ...
        globIgnores: [
          ...
          // Chỉ dùng ở desktop: để mobile không tải nền trong lúc cài/cập nhật PWA.
          '**/assets/AiAssistantPage-*',
          '**/assets/AppointmentsView-*',
          '**/assets/MediaView-*',
          '**/assets/FriendsView-*',
          '**/assets/DashboardView-*',
          '**/assets/UsersRbacView-*',
          '**/assets/GroupsView-*',
          '**/assets/ListsView-*',
          '**/assets/OutreachCampaignsView-*',
          '**/assets/FollowupBuilderView-*',
          '**/assets/DepartmentsView-*',
          '**/assets/*Report-*',
        ],
